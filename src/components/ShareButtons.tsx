    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <a
                ...
                className="flex items-center justify-center h-9 w-9 sm:h-7 sm:w-7 rounded-full bg-[#1877F2] hover:bg-[#1464d1] transition-colors"
            >
            ...
            <a
                ...
                className="flex items-center justify-center h-9 w-9 sm:h-7 sm:w-7 rounded-full bg-[#0A66C2] hover:bg-[#0856a8] transition-colors"
            >
                <svg className="h-4 w-4 sm:h-3.5 sm:w-3.5 fill-white" viewBox="0 0 24 24">
            ...
            <a
                ...
                className="flex items-center justify-center h-9 w-9 sm:h-7 sm:w-7 rounded-full bg-black hover:bg-slate-800 transition-colors"
            >
                <svg className="h-4 w-4 sm:h-3.5 sm:w-3.5 fill-white" viewBox="0 0 24 24">
