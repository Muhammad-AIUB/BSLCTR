            ...
            {tab === "list" && (
                <div className="max-w-4xl mx-auto">
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-slate-500">No webinars yet.</div>
                    ) : (
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-slate-600 mb-3">
                ...
                <a href={w.link} target="_blank" rel="noreferrer" className="flex items-center gap-1 text-primary hover:underline outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2">
